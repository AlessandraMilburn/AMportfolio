...
/*
 * Template Name: About
 * description: this is a template for About Page
...
get_header(); ?>
  ...
  <div class="page-container">
    ...
    <div>
      ...
      <!--PRODUCTIVITY-->
      <div>
      <p> I manage my time effectively ensuring a healthy balance between work productivity, happy lifestyle and real rest.</p>
      ...
      <div class="rectangle-container">
        ...
        <div class="beige-rectangle-column">
          <h5><b>TRACKING MY GOALS</b>
            <br>using a personalized goal management spreadsheet
          </h5>
        </div>
      </div>
      ...
      <!--PODCASTS-->
      <p> On my downtime I listen to a lot of podcasts </p>
      ...
      <div class="box-container">
        <div class="beige-box-row">
          <h5>BUILDING<br>THINGS</h5>
        </div>
        <div class="beige-box-row">
          <h5>BUILDING<br>RELATIONSHIPS</h5>
        </div>
        <div class="beige-box-row">
          <h5>BUILDING<br>EXPOSURE</h5>
        </div>
      </div>
      ...
      <!-- KNOW MORE -->
      <p>Check out my portfolio and my blog to learn more about what I've done and how I do them</p>
      <figure class="separator"></figure>

      <div class="black-rectangle-button">
        <a  href="/portfolio/"><h4>VIEW PORTFOLIO</h4></a>
      </div>
      <div class="black-rectangle-button">
        <a  href="/blog/"><h4>VIEW BLOG</h4></a>  
      </div>
    </div>
